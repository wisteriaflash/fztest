...
//		jSuccess( message, [title, callback] )
...
(function($) {
	...
	$.alerts = {
		...
		confirm: function(message, title, callback, hasCancel) {
		...
		_show: function(title, msg, value, type, callback, hasCancel) {
			$.alerts._hide();
			...
			switch( type ) {
				...
				case 'confirm':
					...
					if(hasCancel==null||hasCancel=="undefined"){
						hasCancel=true;
					}
					if(!hasCancel){
						$("#popup_cancel").hide();
	...
	jConfirm = function(message, title, callback, hasCancel) {		
		$.alerts.confirm(message, title, callback, hasCancel);
	};
